...
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `@service(#{ title })`                                                                                                                            | Marks an application boundary; `title` → `info.title`. Each declared service gets its own document, including empty services. See [service selection and filenames](../emitter-options#service-documents-and-filenames). |
