...
/** Compiler semantics with no mapping in this self-contained proto3 artifact. */
export function unsupportedProtobufMetadata(program: Program, type: Type): string[] {
  ...
  if (type.kind === "ModelProperty") {
    if (type.defaultValue !== undefined) unsupported.push("an explicit TypeSpec default");
